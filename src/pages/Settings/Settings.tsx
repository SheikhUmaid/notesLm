...
export const Settings = ({ userId }: SettingsProps) => {
  ...
  return (
    <Box sx={{ p: 2, mx: 'auto', maxWidth: theme.breakpoints.values.md }}>
      ...
      >
        Export your NotesLM profile data so that it can be moved to another
        browser or device.{' '}
      ...
      >
        Import your NotesLM profile that was previously exported from another
        browser or device.
      </Typography>
      <FileReaderInput
        {...{
      ...
      >
        ...
        NotesLM application preferences.
      </Typography>
      <Button
        variant="outlined"
        color="error"
      ...
      >
        NotesLM only stores user preferences and never message content of any
        kind. This preference data is only stored locally on your device and not
        a server.
      </Typography>
      <Divider sx={{ my: 2 }} />
    </Box>
